...
- [ ] **R5.1** Definir y aplicar la política Argentina autoritativa en API/favoritos (W1).
- [ ] **R5.2** Alinear CLI y validación del catálogo con esa autoridad (W2).
- [ ] **R5.3** Alinear fecha inicial, picker, validación y stepper Angular (W3).
...
|---|---|---|
| P5-W1 | P4 DONE | Política backend APOD + rutas/favoritos y tests de borde |
| P5-W2 | W1 | Límite coherente del catálogo local |
| P5-W3 | W2 | Picker, validación y stepper Angular |
